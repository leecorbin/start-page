...
lexicon/
  ...
  README.md            # this file
  ingest/              # one module per source + orchestrator (run-all.js)
...
# then bulk-load the ingested data into remote D1 (see SPEC.md §7 — a batched
# INSERT/import step; not yet scripted, since Phase 1 hasn't started)
npx wrangler deploy
```
